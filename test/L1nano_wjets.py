...
# with command line options: -s L1,L1TrackTrigger,L1P2GT,USER:PhysicsTools/L1Nano/l1tPh2Nano_cff.l1tPh2NanoTask --conditions auto:phase2_realistic_T33 --geometry Extended2026D110 --era Phase2C17I13M9 --eventcontent NANOAOD --datatier GEN-SIM-DIGI-RAW-MINIAOD --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring,L1Trigger/Configuration/customisePhase2TTOn110.customisePhase2TTOn110,PhysicsTools/L1Nano/l1tPh2Nano_cff.addFullPh2L1Nano --filein /store/mc/Phase2Spring24DIGIRECOMiniAOD/GluGluToHHTo4B_node_SM_TuneCP5_14TeV-amcatnlo-pythia8/GEN-SIM-DIGI-RAW-MINIAOD/PU200_AllTP_140X_mcRun4_realistic_v4-v1/130000/03474707-bf67-466b-9886-8d6379bf66e9.root --fileout file:output_Phase2_L1T.root --python_filename L1nano_cfg.py --inputCommands=keep *, drop l1tPFJets_*_*_*, drop l1tTrackerMuons_l1tTkMuonsGmt*_*_HLT --mc -n 10 --nThreads 1 --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/mc/Phase2Spring24DIGIRECOMiniAOD/GluGluToHHTo4B_node_SM_TuneCP5_14TeV-amcatnlo-pythia8/GEN-SIM-DIGI-RAW-MINIAOD/PU200_AllTP_140X_mcRun4_realistic_v4-v1/130000/03474707-bf67-466b-9886-8d6379bf66e9.root'),
